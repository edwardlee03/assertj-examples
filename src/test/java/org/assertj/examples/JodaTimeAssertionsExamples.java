...
public class JodaTimeAssertionsExamples extends AbstractAssertionsExamples {
  ...
  public void dateTime_assertions_examples() {
    ...
    assertThat(new DateTime("2000-01-01"))
        .isEqualTo(new DateTime("2000-01-01"))
        .isNotEqualTo(new DateTime("2000-01-15"));
    ...
    assertThat(new DateTime("2000-01-01"))
        .isBeforeOrEqualTo(new DateTime("2000-01-01"));
    assertThat(new DateTime("2000-01-01"))
        .isAfterOrEqualTo(new DateTime("2000-01-01"));
    assertThat(new DateTime("2000-01-01"))
        .isBefore(new DateTime("2000-01-02"))
        .isAfter(new DateTime("1999-12-31"));
    // same assertions but parameters is String based representation of DateTime
    assertThat(new DateTime("2000-01-01"))
        .isBefore("2000-01-02")
        .isAfter("1999-12-31");
    ...
    assertThat(new DateTime("2000-01-01"))
        .isIn(new DateTime("1999-12-31"), new DateTime("2000-01-01"));
    assertThat(new DateTime("2000-01-01"))
        .isNotIn(new DateTime("1999-12-31"), new DateTime("2000-01-02"));
    // same assertions but parameters is String based representation of DateTime
    assertThat(new DateTime("2000-01-01"))
  ...
  public void localDateTime_assertions_examples() {
    ...
    assertThat(new LocalDateTime("2000-01-01"))
        .isEqualTo(new LocalDateTime("2000-01-01"))
        .isNotEqualTo(new LocalDateTime("2000-01-15"));
    ...
    assertThat(new LocalDateTime("2000-01-01"))
        .isBefore(new LocalDateTime("2000-01-02"))
        .isAfter(new LocalDateTime("1999-12-31"));
    // same assertions but parameters is String based representation of LocalDateTime
    assertThat(new LocalDateTime("2000-01-01"))
        .isBefore("2000-01-02")
        .isAfter("1999-12-31");
